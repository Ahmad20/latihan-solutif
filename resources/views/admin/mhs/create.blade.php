                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header text-center title-2">Tambah Mahasiswa</div>
                                    <div class="card-body">
                                        <form action="{{ route('admin.storeMhs'  ) }}" method="post" novalidate="novalidate">
                                            @csrf
